...
-- Overriding as many default Tukui Skin Templates here if I can.
-- Since BNet Conversation frame is Transparent in my UI give the List a Template so it looks nice.
BNConversationInviteDialogList:SetTemplate("Default")

-- So it overlaps any frames that get in its way
...
local function UpdateFactionSkins()
	...
	ReputationDetailFrame:SetAlpha(0.8)
end
...
-----------------------------------------------
-- Method of Skinning Blizzard Frames
-----------------------------------------------
